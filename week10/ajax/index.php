...
<body>
    ...
    <div class="container"> <!-- Fixed incomplete tag -->
        ...
        <form method="post" class="form-data" id="form-data">
            <div class="form-group">
                ...
                <p class="text-danger" id="err_nama"></p> <!-- Added error element -->
            </div>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <p class="text-danger" id="err_jenis_kelamin"></p> <!-- Added error element -->
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <p class="text-danger" id="err_alamat"></p> <!-- Added error element -->
            </div>

            <div class="form-group">
                <label>No Telepon:</label>
                <input type="number" name="no_telp" id="no_telp" class="form-control" required>
                <p class="text-danger" id="err_no_telp"></p> <!-- Added error element -->
            </div>
        ...
        $("#simpan").click(function() {
            ...
            if (nama != "" && alamat != "" && (document.getElementById("jenkel1").checked == true || document.getElementById("jenkel2").checked == true) && no_telp != "") {
                $.ajax({
                    ...
                    error: function(response) { // Fixed case error (Function -> function)
